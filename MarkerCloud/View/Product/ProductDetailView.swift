...
//                                          value: feed.title.isEmpty ? " " : feed.title,
//                                          icon: "chevron.right")
//                            }
...
//                                          value: feed.title.isEmpty ? " " : feed.title, icon: nil)
//                                Button {
//                                    withAnimation(.easeInOut) { isScriptExpanded.toggle() }
//                                } label: {
//                                    RowButton(title: "상품 설명",
//                                              value: isScriptExpanded ? " " : clean(feed.body),
...
//                                        RemoteThumb(url: feed.product.imgUrl)
//                                            .padding(.top, 6)
...
//                ChangeproductName(name: feed.title)
//            } else if productRoute == .postMemoRoute {
//                ChangeproductMemo(productMemo: feed.body)
