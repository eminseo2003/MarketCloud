                ...
                VStack(spacing: 16) {
                    ...
                    VStack(spacing: 1) {
                        ...
                        if isHoursExpanded {
                            VStack(spacing: 0) {
                                Button { stoereroute = .weekdayHoursroute } label: {
                                    SubRowButton(title: "평일", value: timeRangeText(store.dayOpenTime, store.dayCloseTime))
                                }
                                Button { stoereroute = .weekendHoursroute } label: {
                                    SubRowButton(title: "주말", value: timeRangeText(store.weekendOpenTime, store.weekendCloseTime))
                                }
                            }
                        ...
                        Button {
                            ...
                            RowButton(title: "주소", value: store.address ?? " ",
                                      icon: "chevron.right")
                        }
