                ...
                Button("등록") {
                    Task {
                            await createVm.createStore(
                                ...
                                weekdayStart: toZTimeString(storeDetail.weekdayOpen),
                                weekdayEnd: toZTimeString(storeDetail.weekdayClose),
                                weekendStart: toZTimeString(storeDetail.weekendOpen),
                                weekendEnd: toZTimeString(storeDetail.weekendClose),
                                address: storeDetail.roadAddress,
