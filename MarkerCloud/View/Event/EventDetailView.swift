...
//                                LargeReviewImage(url: feed.mediaUrl)
//                            }
//                            
//                        }
...
//                                              value: isScriptExpanded ? " " : clean(feed.prompt),
//                                              icon: isScriptExpanded ? "chevron.down" : "chevron.right")
//                                }
//                                if isScriptExpanded {
//                                    SubRowButton(value: clean(feed.body))
//                                    
//                                }
//                                Button {
...
//                                if isHoursExpanded {
//                                    VStack(spacing: 0) {
//                                        TimeSubRowButton(title: "시작", value: timeText(feed.event.startAt))
//                                        TimeSubRowButton(title: "종료", value: timeText(feed.event.endAt))
//                                    }
...
//                                }
//                                if isImagesExpanded {
//                                    RemoteThumb(url: feed.event.imgUrl)
//                                        .padding(.top, 6)
//                                        .transition(.opacity.combined(with: .move(edge: .top)))
//                                    
//                                }
...
//            switch r {
//            case .eventNameRoute:
//                ChangeEventName(name: feed.title)
//            case .eventMemoRoute:
//                ChangeEventMemo(eventMemo: feed.body)
//            case .eventReviewRoute:
//                ReviewListView(reviews: feed.reviews, feed: feed)
//            }
//        }
