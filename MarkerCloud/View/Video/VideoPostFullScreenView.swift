...
//                            
//                            Text(formattedDate(feed.createdAt))
//                                .font(.caption)
//                                .foregroundColor(.white)
//                            Spacer()
//                        }
...
//            }
//        }
//        .task(id: feed.mediaUrl) { await preparePlayer(url: feed.mediaUrl) }
//        .padding(.bottom, 80)
//        .padding(.top, 24)
//        .onAppear {
//            if player == nil {
//                Task { await preparePlayer(url: feed.mediaUrl) }
//            }
//        }
//        .onChange(of: feed.mediaUrl) { _, newURL in
//            pauseAndTearDown()
